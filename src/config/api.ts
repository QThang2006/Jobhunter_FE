...
export const callResetPassword = (email: string, otp: string, newPass: string) => {
    return axios.post<IBackendRes<any>>('/api/v1/auth/reset-password', { email, otp, newPass })
}
...
export const callUpdatePassword = (email: string, oldpass: string, newpass: string) => {
    return axios.post<IBackendRes<any>>(`/api/v1/users/change-password`, { email, oldpass, newpass });
}
...
/**
 * Send approval email with interview schedule
 */
export const callSendApprovalEmail = (resumeId: string, interviewDate: string, interviewTime: string) => {
    return axios.post<IBackendRes<any>>('/api/v1/email/approve', {
        resumeId,
        interviewDate,
        interviewTime
    });
...
export const callSendIntroEmail = () => {
